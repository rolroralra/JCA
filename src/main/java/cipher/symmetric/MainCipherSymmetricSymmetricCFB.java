...
public class MainCipherSymmetricSymmetricCFB extends SymmetricCipher {
...
//        System.out.println(secureRandom.getProvider());
        byte[] ivBytes = new byte[Cipher.getInstance("AES/CFB/NoPadding").getBlockSize()];   // 128 bit = 16 byte
        System.out.println("Block Size : " + Cipher.getInstance("AES/CFB/NoPadding").getBlockSize());
